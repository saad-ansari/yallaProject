...
- (void)configureViewForAlertType:(ISAlertType)alertType iconImage:(UIImage*)iconImage {
    ...
    switch (alertType) {
        ...
        {
            self.titleLabelTextColor = [UIColor colorWithRed:90.f/255.f green:103.f/255.f blue:115.f/255.f alpha:1.f];
            
            self.messageLabelTextColor = [UIColor colorWithRed:90.f/255.f green:103.f/255.f blue:115.f/255.f alpha:1.f];
            
            self.alertViewBackgroundColor = [UIColor colorWithRed:163.f/255.f green:203.f/255.f blue:1.f/255.f alpha:1.f];
            if (!_iconImage) {
                self.iconImage = [self imageNamed:@"g_close-circle"];
            }
            break;
        }
        ...
        case ISAlertTypeWarning: {
            self.alertViewBackgroundColor = [UIColor colorWithRed:252.f/255.f green:235.f/255.f blue:34.f/255.f alpha:1.f];
            if (!_iconImage)
            {
                self.iconImage = [self imageNamed:@"isErrorIcon"];
            }
