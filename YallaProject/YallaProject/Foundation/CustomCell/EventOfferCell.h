...
@interface EventOfferCell : UITableViewCell
...
@property (nonatomic,weak)IBOutlet UILabel *lblFree;
...
@property (nonatomic,weak)IBOutlet UILabel *leftLbl;
@property (nonatomic,weak)IBOutlet UIImageView *bg_image;
@property (nonatomic,weak)IBOutlet UIImageView *iconClock;

@property (nonatomic,weak)IBOutlet UIView *saveView;
@property (nonatomic,weak)IBOutlet UIView *saveLbl;
